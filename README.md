...
Access folder backend `cd backend`, install the JSON Server `npm i json-server` and run  `npm start` for simulate an API using JSON Server. Navigate to `http://localhost:3000/pensamentos`, to view the data.
